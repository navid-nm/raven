...
Syntax highlighting and autocomplete for Raven, a language that compiles to JS. Specifically for simplifying JS-related code, making it more concise, typesafe and expressive.
